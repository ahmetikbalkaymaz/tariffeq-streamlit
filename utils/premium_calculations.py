...
# CONSTANT TABLES
# ------------------------------------------------------------
# Oranlar 05.10.2025 tarihinde %10 artırılmıştır.
tarife_oranlari = {
    "Betonarme": [3.44, 2.89, 2.62, 2.13, 1.52, 1.17, 0.83],
    "Diğer": [6.74, 6.12, 4.13, 2.20, 1.72, 1.36, 1.17],
    "RiskGrubuA": [1.72, 1.44, 1.31, 1.08, 0.76, 0.59, 0.42],
    "RiskGrubuB": [3.37, 3.07, 2.07, 1.10, 0.87, 0.69, 0.59]
}
koasurans_indirimi = {
