...
# --- AI FONKSİYONLARI ---
# DÜZELTİLMİŞ get_ai_driven_parameters FONKSİYONU
...
def get_ai_driven_parameters(faaliyet_tanimi: str) -> Dict[str, str]:
    ...
    """
    try:
        # HATA DÜZELTİLDİ: Geçerli bir model adı kullanıldı.
...
# DÜZELTİLMİŞ generate_report FONKSİYONU
@st.cache_data(show_spinner=False)
def generate_report(s: ScenarioInputs, pd_ratio: float, gross_bi_days: int, net_bi_days: int, pd_damage: float, bi_damage: float) -> str:
    ...
    **ANALİZ EDİLECEK VERİLER:**
    ...
    try:
        ...
        # HATA DÜZELTİLDİ: Gereksiz ve hataya neden olan 'for' döngüsü kaldırıldı.
